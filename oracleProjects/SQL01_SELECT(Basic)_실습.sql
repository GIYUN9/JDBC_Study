...
-- 3. "국어국문학과" 에 다니는 여학생 중 현재 휴햑중인 여학생을 찾아달라는 요청이 들어왔다.
...
-- 4. 도서관에서 대출 도서 장기 연체자 들을 찾아 이름을 개시하고자 한다.
-- 그 대상자들의 학번이 다음과 같을 때 대상자를 찾는 적절한 SQL 구문을 작성하시오
SELECT STUDENT_NAME
FROM TB_STUDENT
